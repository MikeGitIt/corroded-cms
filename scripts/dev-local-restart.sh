...
export SITE_NAME="${CORRODED_CMS_SITE_NAME:-Corroded CMS}"
export SITE_DESCRIPTION="${CORRODED_CMS_SITE_DESCRIPTION:-A Rust-native blog CMS.}"
export RUST_LOG="${CORRODED_CMS_RUST_LOG:-corroded_cms=info,tower_http=info}"
export PORT="${CORRODED_CMS_PORT:-3000}"

exec "$(dirname "$0")/dev-restart.sh"
